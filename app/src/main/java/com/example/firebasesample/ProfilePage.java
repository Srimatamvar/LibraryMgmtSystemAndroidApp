...
public class ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        df3.addSnapshotListener(ProfilePage.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                if(value!=null){
                    String ul = value.getString("profileImage");
                    Glide.with(ProfilePage.this).load(ul).into(i1);
        ...
        upd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder2 = new AlertDialog.Builder(ProfilePage.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        auth.getCurrentUser().updatePassword(input.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(ProfilePage.this, "Password updated Successfully", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ProfilePage.this, "Password not updated", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
        ...
        df1.addSnapshotListener(ProfilePage.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                if(value!=null){
                    ...
                    name.setText(n);
                    em.setText(setemail);
                    Glide.with(ProfilePage.this).load(u).into(imageView);
        ...
        save2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                df.update(userinfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(ProfilePage.this, "change success", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
    ...
    private void geturl(final String random) {
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                save1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        df.update(userinfo);
                        Toast.makeText(ProfilePage.this, "Changes successfully saved", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ProfilePage.this, "Failed to saved", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadPicture() {
        ...
        ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(ProfilePage.this, "image not uploaded", Toast.LENGTH_SHORT).show();
            }
